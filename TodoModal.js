...
import {Text,View,TouchableOpacity,StyleSheet,FlatList,KeyboardAvoidingView,TextInput,Keyboard,SafeAreaView} from 'react-native';
  ...
  renderTodo = (todo, index) =>{
    return(
       <View style={styles.todoContainer}>
            <TouchableOpacity style={{}} onPress={()=>this.toggleTodoCompleted(index)}>
     ...
     return(
       ...
       <SafeAreaView style={styles.container}>
          ...
          <View style={[styles.section,styles.footer]}>
            <TextInput style={[styles.input,{borderColor:this.state.color}]} onChangeText={text=>this.setState({newTodo:text})} value={this.state.newTodo} />
